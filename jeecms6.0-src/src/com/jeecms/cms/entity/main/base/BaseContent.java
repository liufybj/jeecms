 ...
 * 
 * @hibernate.class table="jc_content"
 */
public abstract class BaseContent implements Serializable {
	 ...
	 */
	public BaseContent(java.lang.Integer id, com.jeecms.core.entity.CmsSite site, java.util.Date sortDate,
	...
	public void setJobApplys(java.util.Set<com.jeecms.cms.entity.assist.CmsJobApply> jobApplys) {
	...
	public void setScoreRecordSet(java.util.Set<com.jeecms.cms.entity.assist.CmsScoreRecord> scoreRecordSet) {
	...
	public void setCollectUsers(java.util.Set<com.jeecms.core.entity.CmsUser> collectUsers) {
	...
	public void setComments(java.util.Set<com.jeecms.cms.entity.assist.CmsComment> comments) {
